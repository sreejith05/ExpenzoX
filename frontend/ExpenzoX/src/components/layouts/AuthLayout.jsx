...
const AuthLayout = ({children}) => {
  return <div className="flex"> 
    <div className="w-screen h-screen md:w-[60vw] px-12 pt-8 pb-12">
        <h3 className="text-3xl font-bold text-purple-800">ExpenzoX</h3>
        <p className="text-sm text-black mt-1">Track Smart. Spend Smarter.</p>
        {children}
    </div>

    <div className="hidden md:block w-[40vw] h-screen bg-violet bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative">
